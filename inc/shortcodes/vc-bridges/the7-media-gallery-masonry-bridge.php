...
return array(
	...
	'params'            => array(
		...
		array(
			...
			"value"			=> 'rgba(0,0,0,.25)',
			"default_colorpicker_color" => 'rgba(0,0,0,.25)',
			'dependency' => array(
				'element' => 'image_decoration',
				'value' => 'shadow',
			),
		...
		array(
			...
			'default_colorpicker_color' => 'rgba(0,0,0,0.5)',
			'dependency'  => array(
		...
		array(
			...
			'default_colorpicker_color' => 'rgba(255,255,255,1)',
			'dependency'       => array(
				'element' => 'show_zoom',
				'value'   => 'y',
			),
		...
		array(
			...
			'default_colorpicker_color' => 'rgba(255,255,255,0.3)',
			'dependency'       => array(
