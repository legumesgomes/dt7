...
class The7_Inc_Shortcodes_VCParams {
	...
	public function __construct() {
		add_action( 'vc_edit_form_fields_after_render', function() {
			$script_url = PRESSCORE_SHORTCODES_URI . '/vc_extend/dt-vc-scripts.js';
			?>
			<script src="<?php echo esc_url( $script_url ); ?>"></script>
			<?php
		} );
		add_action( 'vc_load_default_params', array( $this, 'register_params' ) );
	...
	public function register_params() {
		...
		$this->add_shortcode_param( 'dt_taxonomy', array( $this, 'taxonomy_settings_field' ) );
		// Intentional use of concatenation.
		$this->add_shortcode_param( 'dt_post' . 'type', array( $this, 'post_type_settings_field' ) ); // phpcs:ignore
		$this->add_shortcode_param( 'dt_spacing', array( $this, 'spacing_param' ) );
		$this->add_shortcode_param( 'dt_responsive_columns', array( $this, 'responsive_columns_param' ) );
		$this->add_shortcode_param( 'dt_dimensions', array( $this, 'dimensions_param' ) );
		$this->add_shortcode_param( 'dt_number', array( $this, 'number_param' ) );
		$this->add_shortcode_param( 'dt_number_with_icon', array( $this, 'number_param_with_icon' ) );
		$this->add_shortcode_param( 'dt_font_style', array( $this, 'font_style_param' ) );
		$this->add_shortcode_param( 'dt_switch', array( $this, 'switch_param' ) );
		$this->add_shortcode_param( 'dt_navigation', array( $this, 'dt_icon_settings_field' ) );
		$this->add_shortcode_param( 'icon_manager', array( $this, 'dt_icon_settings_field' ) );
		$this->add_shortcode_param( 'dt_soc_icon_manager', array( $this, 'dt_icon_settings_field' ) );
		$this->add_shortcode_param( 'dt_radio_image', array( $this, 'dt_image_param' ) );
